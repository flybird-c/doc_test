...
public class TestDocUtilsController {
    ...
    //    return DocUtil.getDocCodes(codeList,srcWordPath);
    //}
    //
    ...
    //    return DocUtil.replaceWordCode(map,srcWordPath);
    //}
    //
    ...
    //    return DocUtil.getPdfByWordPath(filePath);
    //}
    //
    ...
    //    DocUtil.openPdf(fileLocalName,response);
    //}
    ...
    //) throws ServiceException {
    //    return DocUtil.getHtmlByWordPath(filePath);
    //}
    //
    ...
    //    DocUtil.openHtml(fileLocalName,response);
    //}
